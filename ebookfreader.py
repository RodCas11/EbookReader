...
class PDFReader:
    def __init__(self):
        ...
        self.root.configure(bg='#333')  # Cor de fundo escura

        self.text = tk.Label(self.root, wraplength=500, font=("Helvetica", 14), bg='#333', fg='white')  # Fundo escuro e texto branco
        self.text.pack(fill="both", expand=True)

        file_button = tk.Button(self.root, text="Selecionar PDF", command=self.select_pdf)
        file_button.pack(side="top", pady=10)

        speed_frame = tk.Frame(self.root, bg='#333')  # Cor de fundo escura
        speed_frame.pack(side="top", pady=10)

        self.speed_label = tk.Label(speed_frame, text="Speed:", bg='#333', fg='white')  # Cor de fundo escura e texto branco
        ...
        button_frame = tk.Frame(self.root, bg='#333')  # Cor de fundo escura
